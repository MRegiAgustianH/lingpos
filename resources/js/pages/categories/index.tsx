...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Kelola Kategori', href: '/categories' },
];
...
export default function KelolaKategori({ categories }: Props) {
            ...
            <AlertDialog open={!!deleteId} onOpenChange={(isOpen) => !isOpen && setDeleteId(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Tindakan ini tidak dapat dibatalkan. Ini akan menghapus data kategori tersebut secara permanen.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
